...
private:
    ...
    using chunked_chunked_resource_iterator_t = std::ranges::iterator_t<chunked_resource_type>;
    //!\}
...
private:
    ...
    size_t underflow()
    {
        ...
        {
            auto current_chunk = *chunked_resource_it;
    ...
    chunked_chunked_resource_iterator_t chunked_resource_it{};
