...
public:
     ...
     * \param[in] chunk_size The number of sequences pairs to invoke the alignment algorithm with.
     * \param[in] exec Optional execution policy to use. Defaults to seqan3::seq if not set.
     *
